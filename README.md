...
La solution proposée est "frwTNRWebLMS_BDD" basée sur Selenium webdriver, cucumber et Junit.
...
# Reporting 
Les résultats de test s’affichent dans un rapport Extent nommé LMS_Report.html dans le dossier Target / Cucumber-reports
